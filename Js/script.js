...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Feliz Dia de la Mujer Anaiz <3!!!!.\n\n Recuerda que eres una hija amada de Dios y tu valor es infinito, se que tienes muchos problemas , no permitas que eso te aleje del gran banquete de oportunidades que Dios tiene para ti, si tu sonrisa es tan bonita para que la vas a guardar? .`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Beckhan <3";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + '0)') : new Date('0)'); 
  let eventDate = eventParam ? new Date(eventParam + '0)') : new Date('0)');
